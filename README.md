...
## 🎥 Demo 
📹 **[Video Demo (https://github.com/user-attachments/assets/07357c0c-c5a2-4a12-9822-f81ae25a6f31)](https://youtu.be/rr4ewcUh3Qs)**  
🖼️ **Screenshots:**  
...
```sh
   git clone [https://github.com/ewfx/gaidp-prism.git]
```
